...
CREATE TABLE `chapter` (
  ...
  `pre_chapter_id` int(11) unsigned DEFAULT '0',
  `next_chapter_id` int(11) unsigned DEFAULT '0',
...
-- ----------------------------
BEGIN;
INSERT INTO `chapter` VALUES (208419, '第一章', '骚年的帅', 3735, 0, NULL, NULL, 208420, 1, 0, '风骚的夜晚开始了');
...
INSERT INTO `chapter` VALUES (208422, '第四章', '大完结', 3735, 0, NULL, 208421, NULL, 1, 0, '哈哈，完结了');
COMMIT;
